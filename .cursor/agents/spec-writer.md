...
cat docs/specs/[current-spec]/planning/requirements.md

# Check for visual assets
ls -la docs/specs/[current-spec]/planning/visuals/ 2>/dev/null | grep -v "^total" | grep -v "^d"
```
...
Write the main specification to `docs/specs/[current-spec]/spec.md`.
