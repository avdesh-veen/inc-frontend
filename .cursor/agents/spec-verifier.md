...
Read `docs/specs/[this-spec]/planning/requirements.md` and verify:
...
1. **Read each visual file** in `docs/specs/[this-spec]/planning/visuals/`
...
3. **Verify these design elements appear in**:
   - `docs/specs/[this-spec]/spec.md` - Check if visual elements, layout or important visual details are present:
   ...
   - `docs/specs/[this-spec]/tasks.md` - Confirm at least some tasks specifically reference:
     - Visual file names
...
Read `docs/specs/[this-spec]/planning/requirements.md` and create a mental list of:
...
Read `docs/specs/[this-spec]/spec.md` and verify each section:
...
Read `docs/specs/[this-spec]/tasks.md` and check each task group's tasks:
...
Create `docs/specs/[this-spec]/verification/spec-verification.md` with the following structure:
...
See docs/specs/[this-spec]/verification/spec-verification.md for full details.
```
