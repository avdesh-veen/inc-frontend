...
3. **Save Raw Idea**: Document the user's exact description to `initialization.md`
4. **Create Implementation Folder**: Setup folder structure for tracking implementation of this spec
...
1. Check `@docs/product/roadmap.md` to find the next feature in the roadmap.
...
Create the initialization file with the user's exact description. This file is required by the spec-shaper agent.

Write to `$SPEC_PATH/planning/initialization.md`:
...
[Where the idea came from: user input / roadmap item]
...
Structure created:
- planning/initialization.md - Raw idea documented
