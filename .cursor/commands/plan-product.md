...
This process will create these files in `docs/product/` directory.
...
- Create `docs/product/mission.md` with product vision and strategy
- Create `docs/product/roadmap.md` with phased development plan
- Create `docs/product/tech-stack.md` documenting all of this product's tech stack choices
