...
- `docs/specs/[this-spec]/spec.md`
- `docs/specs/[this-spec]/planning/requirements.md`
...
- `docs/specs/[this-spec]/spec.md` (if present)
- `docs/specs/[this-spec]/planning/requirements.md` (if present)
- `docs/specs/[this-spec]/planning/visuals/` and its' contents (if present)
...
✅ Tasks list created: `docs/specs/[this-spec]/tasks.md`
