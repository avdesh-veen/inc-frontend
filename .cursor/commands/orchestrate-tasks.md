...
In this spec's folder, create this file: `docs/specs/[this-spec]/orchestration.yml`.
...
Loop through each task group in `docs/specs/[this-spec]/tasks.md` and delegate its implementation to the assigned subagent specified in `orchestration.yml`.

For each delegation, provide the subagent with:

- The task group (including the parent task and all sub-tasks)
- The spec file: `docs/specs/[this-spec]/spec.md`
- Instruct subagent to:
  - Perform their implementation
  - Check off the task and sub-task(s) in `docs/specs/[this-spec]/tasks.md`
