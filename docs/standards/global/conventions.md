...
- **API Implementation Policy**: Do NOT implement any backend API implementations or API route handlers unless explicitly requested by the user. This is a frontend-only codebase that consumes external APIs.
