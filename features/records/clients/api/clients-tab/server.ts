 ...
 */
export async function getClientsListServer(request?: ClientRequest): Promise<ApiResponse<PaginatedResponse<ClientListItem>>> {
 ...
 * Get client by ID
 */
export async function getClientByIdServer(id: string): Promise<ApiResponse<Client>> {
